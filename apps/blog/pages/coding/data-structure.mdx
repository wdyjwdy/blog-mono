import { Table, AspectRatio } from '@radix-ui/themes';
import Image from 'next/image'
 

# Data Structure
## Stack
<Image src="/img/coding/data-structure/stack.png" alt="stack" width={300} height={300} style={{ margin: '0 auto'}} />
...
```
## Queue
<Image src="/img/coding/data-structure/queue.png" alt="queue" width={300} height={300} style={{ margin: '0 auto' }} />
<Table.Root variant='surface' mt='20px'>
  <Table.Header>
    <Table.Row>
      <Table.ColumnHeaderCell>Methods</Table.ColumnHeaderCell>
...
```
## LinkedList
<Image src="/img/coding/data-structure/linked-list.png" alt="linked-list" width={500} height={500} style={{ margin: '0 auto'}} />
<Table.Root variant='surface' mt='20px'>
  <Table.Header>
    <Table.Row>
      <Table.ColumnHeaderCell>Methods</Table.ColumnHeaderCell>
