...
## Static Methods
### create
![create](public/img/coding/js/object/create.png)
1. 创建一个空实例
2. 空实例原型 *->* `proto`
```js
...
## Others
### instanceof
![instanceof](public/img/coding/js/object/instanceof.png)
1. 遍历 `a` 的原型链
2. 检查 `b` 的原型是否在其中
```js {4}
...
```
### new
![new](public/img/coding/js/object/new.png)
1. 创建一个空实例
2. 调用构造函数（`this` *->* 空实例）
3. 空实例原型 *->* 构造函数原型
```js
...
```
### extends
![extends](public/img/coding/js/object/extends.png)
